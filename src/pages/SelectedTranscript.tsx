        ...
        <div className="flex flex-col gap-2">
          <div className="w-full justify-between items-center flex ">
            <div className="flex gap-2 items-center">
              ...
              <h1 className="text-[24px] md:text-[30px] text-slate-500 dark:text-gray tracking-tight">Hello, {data?.data.name}</h1>
            </div>
            <div className="flex items-center gap-2 py-2 px-5 rounded-[10px] shadow-black/20 shadow-[0px_12px_26px_2px]">
              <MdTimer size={20} />
              <p>{moment(data?.data.createdAt).format("LLL")}</p>
            </div>
          </div>
          {/* Content */}
